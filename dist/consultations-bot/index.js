...
consultationBot.command('request', async (ctx) => {
    ...
    if (!check) {
        await ctx.reply('В ближайшее время с вами свяжется менеджер для согласования удобного времени. Для дальнейшей работы требуется ваше согласие на обработку персональных данных.\n\nНажмите кнопку ниже.', {
            reply_markup: {
                inline_keyboard: [
                    [
