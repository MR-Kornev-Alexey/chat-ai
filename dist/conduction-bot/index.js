...
const start = "Уникальность ведения -  одновременная  работа в двух направлениях – с мамой и с ребёнком. Такой подход гарантирует высокую эффективность и быстрые результаты.\n" +
    "\n" +
    "Что тебя ждет?\n" +
    "\n" +
    "Для мамы:\n" +
